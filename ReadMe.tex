...
\section{First Approach} I begin by using the easiest possible approach to get results for comparison with later attempts. The first approach attempts to classify pictures of leaves from two species: \textit{Abies Concolor} and \textit{Abies Nordmanniana} using logistic regression. 
...
\includegraphics[scale=0.3]{C:/Users/Geoffrey/Google Drive/Machine Learning/Leaf project/abies_concolor_ex.jpg} \includegraphics[scale=0.3]{C:/Users/Geoffrey/Google Drive/Machine Learning/Leaf project/abies_nordmaniana_ex}
